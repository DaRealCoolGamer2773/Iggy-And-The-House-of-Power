...
if setup == false
	...
	for(var p = 0; p < page_number; p++)
		...
		//gets the x position for the textbox
		...
		//setting individual characters an finding where the lines of text should break
...
if draw_char == text_length[page] && page == page_number - 1
	...
	//option selection
	option_pos += (keyboard_check_pressed(vk_down) || keyboard_check(ord("S"))) - (keyboard_check_pressed(vk_up) || keyboard_check(ord("W")));
